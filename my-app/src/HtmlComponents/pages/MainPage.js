            ...
            <div className='space_beetwen search'>
                <div className='search'>
                    <img className='searchImg' src='search.png'></img>
                    {
                        user.language == "ru" ? (
                            ...
                            placeholder="Поиск по тегу" id="tagFind"
                            onKeyUp={FindingBranchesTag}></input>
                        ) : (
                            <input type="text" className="searchInput" 
                            placeholder="Find by tag" id="tagFind"
                            onKeyUp={FindingBranchesTag}></input>
                        )
                    }
                </div>
                <div className='search'>
                    <img className='searchImg' src='search.png'></img>
                    {
                        user.language == "ru" ? 
                        (
                            <input type="text" className="searchInput" placeholder="Поиск по заголовку" 
                            id="titleFind" onKeyUp={FindingBranchesTitle}></input>
                        ) : (
                            <input type="text" className="searchInput"  placeholder="Find by title" 
                            id="titleFind" onKeyUp={FindingBranchesTitle}></input>
                        )
                    }
